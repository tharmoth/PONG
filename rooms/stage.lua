...
function Stage:new()
    ...
    self.area:addGameObject('Player',    10,  0,   {width = 20,  height = 80,  name = 'player1', playerNumber = 'one', upKey = 'w',  downKey = 's'   })        
    self.area:addGameObject('Player',    770, 300, {width = 20,  height = 80,  name = 'player2', playerNumber = 'two', upKey = 'up', downKey = 'down'})
